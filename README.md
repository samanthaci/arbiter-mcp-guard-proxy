...
> **Status — archived.** A finished experiment the author is no longer maintaining or deploying. Kept here as-is for reference — unsupported, no releases, and not actively developed.

[![CI](https://github.com/samanthaci/arbiter-mcp-guard-proxy/actions/workflows/ci.yml/badge.svg)](https://github.com/samanthaci/arbiter-mcp-guard-proxy/actions/workflows/ci.yml)
...
the [QuantumBank case study](https://samanthaci.github.io/arbiter-mcp-guard-proxy/case-study.html) for a worked example
...
```bash
curl -sSf https://raw.githubusercontent.com/samanthaci/arbiter-mcp-guard-proxy/main/install.sh | sh
```
...
[QuantumBank scenario](https://samanthaci.github.io/arbiter-mcp-guard-proxy/case-study.html) demonstrates end-to-end
...
[GitHub Issues](https://github.com/samanthaci/arbiter-mcp-guard-proxy/issues), no SLA,
